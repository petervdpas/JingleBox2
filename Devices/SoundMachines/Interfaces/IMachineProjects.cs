...
/// and a static one is a fact about the process: one test calling <see cref="Tracker.Interfaces.IRackDevices{T}.Keep"/> changed
...
/// </remarks>
public interface IMachineProjects : Tracker.Interfaces.IRackDevices<MachineProject>
{
    /// <summary>
