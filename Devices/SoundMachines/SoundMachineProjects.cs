...
/// <inheritdoc/>
public sealed class SoundMachineProjects : RackDevices<SoundMachineProject>, ISoundMachineProjects
{
    /// <inheritdoc/>
    /// <remarks>
    ...
    {
        string slot = JingleBox2.Devices.SoundMachines.Records.SoundMachine.For(kind).SlotId;
