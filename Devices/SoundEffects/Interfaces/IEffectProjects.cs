...
/// for <see cref="Devices.Interfaces.IRackDevices{T}"/> of effects, so a caller says what it
/// wants rather than a shape with a parameter in it.
/// </remarks>
public interface IEffectProjects : Devices.Interfaces.IRackDevices<EffectProject>
{
}
