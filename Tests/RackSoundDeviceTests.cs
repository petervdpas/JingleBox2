...
/// </remarks>
public class RackSoundDeviceTests
{
    /// <summary>A machine's list, filled with machines.</summary>
    private static IRackSoundDevices<SoundMachineProject> Machines(params SoundMachineProject[] found)
    {
    ...
    private static IRackSoundDevices<SoundEffectProject> Effects(params SoundEffectProject[] found)
    {
        var kept = new SoundEffectProjects();
    ...
    public void Both_answer_for_what_they_were_given()
    {
        ...
        var effects = Effects(new SoundEffectProject { Id = "effect.echobox", Name = "EchoBox" });
    ...
    public void An_id_is_matched_without_case()
    {
        ...
        Assert.True(Effects(new SoundEffectProject { Id = "effect.echobox" }).Has("Effect.EchoBox"));
    }
    ...
    public void A_device_with_no_id_is_not_kept()
    {
        ...
        Assert.Empty(Effects(new SoundEffectProject { Id = "", Name = "Nameless" }).All);
    }
    ...
    public void Keeping_a_new_list_forgets_the_one_before()
    {
        ...
        effects.Keep(new[] { new SoundEffectProject { Id = "effect.echobox" } });
        effects.Keep(new[] { new SoundEffectProject { Id = "effect.other" } });
    ...
    public void A_face_with_nothing_on_it_is_nothing_to_draw()
    {
        ...
        var effects = Effects(
            new SoundEffectProject { Id = "effect.faced", Panel = Faced() },
            new SoundEffectProject { Id = "effect.bare" });
