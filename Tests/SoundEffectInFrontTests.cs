...
public class SoundEffectInFrontTests
{
    ...
    {
        var front = new SoundEffectInFront();
    ...
    private sealed class Box(string id, string where) : ISoundEffectShown
    {
        /// <inheritdoc/>
