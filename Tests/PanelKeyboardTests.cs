...
public class PanelKeyboardTests
{
    ...
    {
        Assert.Equal(4, _keyboard.Reveal(new Note(4 * 12), 4));
        Assert.Equal(4, _keyboard.Reveal(new Note(5 * 12 + 7), 4));
        Assert.Equal(4, _keyboard.Reveal(new Note(7 * 12), 4));
    }
    ...
    {
        Assert.Equal(2, _keyboard.Reveal(new Note(2 * 12 + 3), 4));
    }
    ...
    {
        Assert.Equal(5, _keyboard.Reveal(new Note(7 * 12 + 1), 4));
        Assert.Equal(6, _keyboard.Reveal(new Note(8 * 12 + 5), 4));
    }
    ...
    {
        Assert.Equal(7, _keyboard.Reveal(new Note(Note.MaxSemitone), 4));
        Assert.Equal(0, _keyboard.Reveal(new Note(Note.MinSemitone), 4));
        Assert.Equal(4, _keyboard.Reveal(new Note(127), 4));
    }
    ...
    {
        Assert.Equal(4, _keyboard.Reveal(Note.Empty, 4));
        Assert.Equal(4, _keyboard.Reveal(Note.Off, 4));
    }
}
