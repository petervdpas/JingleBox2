...
/// </remarks>
public partial class SoundDevicePanel : UserControl
{
    ...
    {
        if (e.PropertyName == nameof(ISoundDevicePanel.Editor)) Retint();
    }
    ...
    private InstrumentEditorViewModel? Editor => (DataContext as ISoundDevicePanel)?.Editor;

    /// <summary>What this panel is standing in: the rack, or a track's own window.</summary>
    private ISoundDevicePanel? Designer => DataContext as ISoundDevicePanel;
