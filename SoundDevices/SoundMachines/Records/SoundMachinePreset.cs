...
public sealed record SoundMachinePreset(string Name, TrackerInstrument Sound)
{
    ...
    /// <summary>
    /// True for a preset you kept yourself, false for one the machine ships with.
    /// </summary>
    /// <remarks>
    /// Only yours can be replaced or taken off. One the machine ships with would come straight
    /// back the next time the machine is brought up to date, so taking it off would be a lie.
    /// </remarks>
