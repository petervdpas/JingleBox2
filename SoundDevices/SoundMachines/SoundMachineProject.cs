...
/// </remarks>
public sealed class SoundMachineProject : IRackProject, IDesignProject
{
    ...
    /// </remarks>
    public static SoundMachineProject? Open(string folder)
    {
        ...
        try
        {
            var read = JsonSerializer.Deserialize<SoundMachineProject>(File.ReadAllText(manifest), Layout);
