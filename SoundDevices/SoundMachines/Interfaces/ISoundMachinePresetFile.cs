...
/// machine.
/// </remarks>
public interface ISoundMachinePresetFile
{
    ...
    TrackerInstrument? Read(string path, SoundMachineProject machine);
    ...
    string Write(TrackerInstrument sound, SoundMachineProject machine);
    ...
    List<(string Name, string Key, int Semitone)> Buttons(SoundMachineProject machine);
}
