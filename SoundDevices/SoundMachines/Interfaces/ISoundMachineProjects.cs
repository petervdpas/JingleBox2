...
/// </summary>
/// <remarks>
/// <see cref="JingleBox2.SoundDevices.Interfaces.IRackRegistry{T}"/> reads the machines off the disc once, at startup, and hands
...
/// and a static one is a fact about the process: one test calling <see cref="SoundDevices.Interfaces.IRackSoundDevices{T}.Keep"/> changed
...
/// </remarks>
public interface ISoundMachineProjects : SoundDevices.Interfaces.IRackSoundDevices<SoundMachineProject>
{
    /// <summary>
