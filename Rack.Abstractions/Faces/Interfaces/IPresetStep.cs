...
/// </summary>
/// <remarks>
/// Its own contract rather than something inside the picker or the panel, because both of them
/// ask and because what it decides can be put a question to without a window: which of the two
/// steps the pointer is offering, and where along the list a step lands.
/// </remarks>
public interface IPresetStep
{
    /// <summary>
    ...
    /// </remarks>
    int Moved(int picked, int count, int by);
    ...
    /// was going anyway.
    /// </remarks>
    string Side(double x, double middle);
}
