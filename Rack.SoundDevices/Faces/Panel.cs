...
public static class ElementKinds
{
    ...
    /// whoever is showing the panel, through <see cref="JingleBox2.Rack.SoundDevices.SoundMachines.Interfaces.IMachineKeys"/>, the same way the pads
    ...
    /// instant. Those come from the host through <see cref="JingleBox2.Rack.SoundDevices.SoundMachines.Interfaces.IMachinePads"/>, by the same position
    ...
    /// <see cref="JingleBox2.Rack.SoundDevices.SoundMachines.Interfaces.IMachineZones"/> and this draws what it is handed.
    /// </remarks>
    ...
    /// truth and this is the picture of them. Supplied through <see cref="JingleBox2.Rack.SoundDevices.SoundMachines.Interfaces.IMachineSlices"/> by
    ...
    /// <see cref="JingleBox2.Rack.SoundDevices.SoundMachines.Interfaces.IInstrumentName"/>, the same way the presets and the map do, and it is read only
