...
/// <summary>
/// Where a sound device's Menu part sits, one literal each.
/// </summary>
/// <remarks>
/// A Menu is not laid out with the sound device's controls and cannot be: it is the one place the
...
/// is there for a sound device whose own artwork wants that side.
///
...
/// there and nobody could see it, which reads exactly like a sound device that has not been
/// updated. A part that can be placed where it cannot be found is a part with a trap in it.
/// </remarks>
public static class MenuCorners
{
    ...
    /// <summary>
    /// The top right of the panel, which is where one goes unless somebody says otherwise.
    /// </summary>
    ...
    /// <summary>What the property naming it is called in a sound device's file.</summary>
