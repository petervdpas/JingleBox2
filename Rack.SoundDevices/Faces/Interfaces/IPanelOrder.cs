...
/// is plugged in: encoder three drives the third parameter on whatever sound device is in front of
/// you, on every sound device, including one written next year. See docs/hardware-integration.md.
///
...
public interface IPanelOrder
{
    ...
    /// <summary>
    /// The parameter at that place, or nothing when the panel has fewer than that.
    /// </summary>
