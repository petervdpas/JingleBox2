...
public sealed partial class EffectDeviceViewModel : ObservableObject, IChainDevice, IEffectShown
{
    ...
    public EffectDeviceViewModel(
        PluginChainViewModel chain,
        EffectProject effect,
        IEffectEngine engine,
    ...
    public IEffectEngine Engine { get; }
    ...
    /// not.
    /// </remarks>
    public IReadOnlyList<DeviceReading> Summary => _summary ??= Pick();

    /// <inheritdoc cref="Summary"/>
    private IReadOnlyList<DeviceReading>? _summary;
    ...
    private List<DeviceReading> Pick()
    {
        var found = new List<DeviceReading>(Readings);
    ...
    /// </remarks>
    public IPanelValues Values => _values ??= Watched(new EffectValues(Engine));
    ...
    private IPanelValues Watched(EffectValues values)
    {
        values.Said += _ =>
        {
            Reread();
