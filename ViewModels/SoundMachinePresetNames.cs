...
/// </remarks>
public sealed class SoundMachinePresetNames : IPanelPresets
{
    ...
    /// </remarks>
    private readonly SoundMachinePresetDesk _desk;

    /// <summary>Offers the desk's presets to a panel being laid out.</summary>
    public SoundMachinePresetNames(SoundMachinePresetDesk desk) => _desk = desk;
