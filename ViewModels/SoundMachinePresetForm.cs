...
/// </remarks>
public sealed partial class SoundMachinePresetForm : ObservableObject
{
    ...
    private readonly SoundMachineProjectShape _machine;
    ...
    public SoundMachinePresetForm(JsonObject held, SoundMachineProjectShape machine, Action changed, string home = "")
    {
        _held = held;
        _machine = machine;
        _changed = changed;
    ...
    public void Rebuild()
    {
        ...
        {
            if (key is SoundMachinePresetWords.Name or SoundMachinePresetWords.Machine or SoundMachinePresetWords.Browse) continue;
...
public static class SoundMachinePresetWords
{
...
/// </remarks>
public sealed class SoundMachineProjectShape
{
    /// <summary>
    ...
    public SoundMachineProjectShape(Panel? panel, IReadOnlyList<Parameter> parameters)
    {
    ...
    private HashSet<string>? Declared()
    {
        ...
        if (!holder.Properties.TryGetValue(SoundDevices.SoundMachines.SoundMachinePresetFile.SettingsProperty, out string? said)
            || said.Trim().Length == 0)
            return null;
