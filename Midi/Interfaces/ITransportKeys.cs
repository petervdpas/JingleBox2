...
/// </summary>
/// <remarks>
/// Four words and nothing else, because four words is all the hardware has. What they do is
...
///
/// The seam matters more here than the size of it suggests. The four dialects a device can ask
/// in (Mackie Control notes, plain controllers, realtime bytes and machine control), and the
/// fifth that is the device's own file, all come out as one of these, so
/// <see cref="MidiTransportRouter"/> can be tested on raw bytes with nothing behind it but a
/// counter.
/// </remarks>
