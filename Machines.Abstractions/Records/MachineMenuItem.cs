...
namespace JingleBox2.Machines.Records;
...
public sealed record MachineMenuItem(string Said)
{
    ...
    /// <summary>
    /// Which of the Menu's options this line belongs to. See <see cref="MachineMenuOptions"/>.
    /// </summary>
    /// <remarks>
