...
{
    /// <inheritdoc/>
    public IReadOnlyList<string> Of(MachinePanel? panel)
    {
    ...
    /// <inheritdoc/>
    public string At(MachinePanel? panel, int ordinal)
    {
        if (ordinal < 0) return "";
    ...
    /// </remarks>
    private void Walk(MachineElement element, List<string> found, HashSet<string> already)
    {
